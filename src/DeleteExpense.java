...
public class DeleteExpense {
    ...
    public static void removeExpenseById(JFrame frame, JPanel mainMenu, JPanel expensesMenu, ArrayList<Expense> expenses) {

        JPanel deleteField = new JPanel(null);
        deleteField.setBackground(new Color(240, 234, 214));

        JLabel titleLabel = new JLabel("Delete Expense");
        ...
        JLabel idLabel = new JLabel("Enter the ID of the expense to delete:");
        ...
        deleteButton.addActionListener((ActionEvent e) -> {
            ...
            if (expenseToRemove != null) {
                ...
                JOptionPane.showMessageDialog(frame, "Expense with ID " + id + " deleted successfully.", "Success", JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(frame, "Expense with ID " + id + " not found.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        });
